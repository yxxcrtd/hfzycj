...
import com.hfzycj.util.aes.SHA1;
...
public class WXUtil {
	...
	public void saveAccessTokenAndOpenIdByCode(String code, String scope) throws Exception {
		...
		Map<String, String> resMap = getWebAccessToken(code);
	...
	public Map<String, String> verificationAccessToken(String scope) throws Exception {
		...
		if (null == accessToken || null == openId) {
			...
			String authUrl = createdAuthUrl(getNowUrl(true), scope, scope);
	...
	public Map<String, String> getUserInfoByOpenId(String openId) throws Exception {
		...
		if (httpRes == null) {
			String url = String.format("https://api.weixin.qq.com/cgi-bin/user/info?access_token=%s&openid=%s&lang=zh_CN", getAccessToken(), openId);
	...
	public Map<String, Object> getJsApiTicket(String reqUrl) throws Exception {
		...
		if (null == jsApiTicket) {
			// 重新获取ticket
			String apiUrl = String.format("https://api.weixin.qq.com/cgi-bin/ticket/getticket?access_token=%s&type=jsapi", getAccessToken());
	 ...
	 */
	public void sendTemplateMsg(String status, String createTime, String message, String toOpenId, String type, String jumpUrl) throws Exception {
