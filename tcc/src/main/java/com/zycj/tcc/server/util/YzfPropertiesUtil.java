...
*  
*/
public class YzfPropertiesUtil {
	...
	*/ 
	private static final String FILE_NAME = "yizhifu.properties";
	...
	*/
	public static String get(String key){
		if(properties == null){
			synchronized(YzfPropertiesUtil.class){
				if(properties == null){
					loadProperties();
				}
			}
	...
	*/
	private static void loadProperties() {
		...
		InputStream resourceAsStream = YzfPropertiesUtil.class.getClassLoader().getResourceAsStream(FILE_NAME);
		try {
