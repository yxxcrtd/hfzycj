...
import com.tenpay.business.DownloadBillBusiness;
import com.tenpay.business.RefundBusiness;
import com.tenpay.business.RefundQueryBusiness;
import com.tenpay.business.ScanPayBusiness;
...
public class WXPay {
	...
	*/
    public static String requestOrderService(ScanPayReqData scanPayReqDate) throws Exception{
    	return new ScanPayService().request(scanPayReqDate);
    } 
