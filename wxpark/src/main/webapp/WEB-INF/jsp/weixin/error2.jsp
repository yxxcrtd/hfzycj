...
<div data-role="page" data-dom-cache="false">
	...
	<form action="" id="buyform" name="buyform" method="post">
	<div role="main" class="ui-content">
			<div class="ui-field-contain">
			    <label for="textinput-1">服务异常，请稍后重试</label>
			    <button id="btn12" type="button">查看详情555</button>
			</div>
	</div>
	</form>
...
$(document).ready(function(){
		$("#btn12").on("click",function(){
			alert("aaaaa");
			// $(this).hide();
			//window.location.href="orderDetail.shtml?param="+$(this).attr("name");
		});
	});
</script>